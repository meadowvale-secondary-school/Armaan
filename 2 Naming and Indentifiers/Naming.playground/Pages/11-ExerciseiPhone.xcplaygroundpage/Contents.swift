...
let storageUsed = 3*1000
let storageLeft = iPhoneStorage - storageUsed
let minuteOnVideo = storageLeft / 150
print("Therefore, you can print \(minuteOnVideo) minutes of video you can watch!")
